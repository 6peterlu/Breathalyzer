...
public class AbstractCalculatorFragment extends Fragment {
    private TextView fragment_instructions;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_abstract_calculator, container, false);

        fragment_instructions = (TextView) v.findViewById(R.id.fragment_instructions);
    ...
    protected void setOnClickListenerForCalculateButton(final Fragment fragmentToOpen) {
        final SharedPreferences preferences = getActivity().getSharedPreferences("preferences", Context.MODE_PRIVATE);
    ...
    protected void setTextForCalculateButton(int id){
        calculate_bac_button.setText(id);
    }

    protected void setTextForFragmentInstructions(int id){
        fragment_instructions.setText(id);
    }
}
